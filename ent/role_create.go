...
func (rc *RoleCreate) SetNormalizedName(s string) *RoleCreate {
	rc.mutation.SetNormalizedName(s)
	return rc
}

// SetConcurrencyStamp sets the "concurrency_stamp" field.
func (rc *RoleCreate) SetConcurrencyStamp(s string) *RoleCreate {
	rc.mutation.SetConcurrencyStamp(s)
	return rc
}

// SetNillableConcurrencyStamp sets the "concurrency_stamp" field if the given value is not nil.
func (rc *RoleCreate) SetNillableConcurrencyStamp(s *string) *RoleCreate {
	if s != nil {
		rc.SetConcurrencyStamp(*s)
	}
	return rc
}
...
func (rc *RoleCreate) check() error {
	...
	if _, ok := rc.mutation.NormalizedName(); !ok {
		return &ValidationError{Name: "normalized_name", err: errors.New(`ent: missing required field "Role.normalized_name"`)}
	}
	if v, ok := rc.mutation.NormalizedName(); ok {
